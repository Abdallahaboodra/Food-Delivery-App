...
class MenuItemsView extends StatefulWidget {
  ...
  const MenuItemsView({Key? key, required this.mObj, required this.itemsArr})
      : super(key: key);
          ...
          child: Column(
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: ((context, index) {
                  var mObj = widget.itemsArr[index] as Map? ?? {};
                  return MenuItemRow(
                    mObj: mObj,
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => ItemDetailsView(
                            foodSalary: double.parse(mObj["type"].toString()),
                            foodName: mObj["name"].toString(),
                            foodImage: mObj["image"].toString(),
                          ),
                        ),
                      );
                    },
