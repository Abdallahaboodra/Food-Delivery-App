...
import 'package:food_delivery/view/home/delivery_man_home_view.dart';
import 'package:food_delivery/view/login/delivery_man_sing_up_view.dart';
...
class DeliveryManLoginView extends StatefulWidget {
  const DeliveryManLoginView({super.key});

  @override
  State<DeliveryManLoginView> createState() => _DeliveryManLoginViewState();
}

class _DeliveryManLoginViewState extends State<DeliveryManLoginView> {
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const DeliveryManSignUpView(),
                        ),
                      );
                    },
                    child: Row(
