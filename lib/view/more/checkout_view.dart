                    ...
                    children: [
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if (index >= 0 && index < paymentArr.length) {
                            var pObj = paymentArr[index] as Map? ?? {};
                            return value.addCardData.isEmpty
                                ? Container(
                                ...
                                : index >= 0 && index < value.addCardData.length
                                    ? Row(
                                        children: [
                                          Text(
                                          ...
                                          Text(value
                                              .addCardData[index].cardNumber),
                                        ],
                                      )
                                    : SizedBox.shrink();
                          }
                          return SizedBox
                              .shrink(); // إذا كان المؤشر خارج حدود القائمة، فلا يقوم بعرض أي عنصر
                        },
                      )
